...
- Verificar `pnpm test`, `pnpm typecheck`, `pnpm build` y la prueba pertinente. Cambios de informes requieren revisar legibilidad, estados vacíos, procedencia y hashes. Cambios al importador requieren las pruebas Python documentadas.
...
- Conserva la interfaz en español, el fondo oscuro y la paleta existente. Mantén feedback de comandos y estados vacíos. No añadir una activación de live a Telegram.
